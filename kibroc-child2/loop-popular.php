...
<?php if (get_option('adv_listings')=='Yes') : ?><?php if (get_option('ad_listings_freq')=='0') : ?>
  ...
  <div class="prod-cnt prod-box shadow Just-listed">
    <div class="post-block-out featured adso">
      <div class="post-block">
        ...
        <div class="post-left">
          <div class="listo">
            <?php echo'<a href=""><img class="attachment-medium" <img class="attachment-featured-thumbnail" alt="" title="" src="' . appthemes_locate_template_uri('images/no-thumb-130.jpg') . '" /></a>'; ?>
          </div>

          <div class="grido">
            <?php echo'<a><img class="attachment-medium" <img class="attachment-featured-thumbnail" alt="" title="" src="' . appthemes_locate_template_uri('images/no-thumb-grid.jpg') . '" /></a>'; ?>
          </div>
        </div>

        <div class="post-right full">
          <p class="post-desc">
          <?php echo stripslashes(get_option('ad_listings')); ?></p>
        </div>

        <div class="clr"></div>
      </div>
    </div>
  </div><?php endif; ?><?php endif;  $count = 1; ?>
<?php
...
<?php
    ...
    <?php while ( $query->have_posts() ) : $query->the_post(); ?>
      ...
      <div class="prod-cnt prod-box shadow Popular" >
...
<div class="clear"></div>
 <div class="prod-cnt prod-box shadow paging Popular box-list" >
						<?php
							global $cp_has_next_page;
							if ( $cp_has_next_page ) {
								$popular_url = add_query_arg( array( 'sort' => 'popular' ), $post_type_url );
						?>
								<div class=""><a href="<?php echo $popular_url; ?>"> <?php _e( 'View More Ads', APP_TD ); ?> </a></div>
						<?php } ?>
