...
<?php else: ?>
<div class="prod-cnt prod-box paging shadow Just-listed " >
...
<div class="prod-cnt prod-box paging shadow Just-listed " >
	...
	<div class=""><a href="<?php echo $post_type_url; ?>"> <?php _e( 'View More Ads', APP_TD ); ?> </a> 
	<span class="total-ads"><?php
$count_posts = wp_count_posts(APP_POST_TYPE);
$count_posts = wp_count_posts(APP_POST_TYPE);
$ads = $count_posts->publish;
echo "$ads ";?>
<?php _e( 'ads online', APP_TD ); ?>
