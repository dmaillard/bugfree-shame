								...
								<?php while ( $featured->have_posts() ) : $featured->the_post(); ?>
									...
									<li>
										...
										<span class="feat_left">
											...
											<?php if ( $cp_options->ad_images ) jt_ad_featured_thumbnail_s(); ?>
											
											<a class="price_sm"><?php cp_get_price($post->ID, 'cp_price'); ?></a>

											
												<div class="clear"></div>		
										
										<a href="<?php the_permalink(); ?>"><?php if ( mb_strlen( get_the_title() ) >= $cp_options->featured_trim ) echo mb_substr( get_the_title(), 0, $cp_options->featured_trim ).'...'; else the_title(); ?></a>
