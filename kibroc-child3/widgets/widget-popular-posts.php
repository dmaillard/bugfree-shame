...
class themerex_popular_posts_widget extends WP_Widget {
	...
	function form($instance) {
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id('title_popular'); ?>" name="<?php echo $this->get_field_name('title_popular'); ?>" value="<?php echo esc_attr($title_popular); ?>" style="width:100%;" />
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('title_commented'); ?>"><?php _e('Most commented tab title:', 'themerex'); ?></label>
			<input id="<?php echo $this->get_field_id('title_commented'); ?>" name="<?php echo $this->get_field_name('title_commented'); ?>" value="<?php echo esc_attr($title_commented); ?>" style="width:100%;" />
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('title_liked'); ?>"><?php _e('Most liked tab title:', 'themerex'); ?></label>
			<input id="<?php echo $this->get_field_id('title_liked'); ?>" name="<?php echo $this->get_field_name('title_liked'); ?>" value="<?php echo esc_attr($title_liked); ?>" style="width:100%;" />
		</p>
		...
		<p>
			...
			<input type="radio" id="<?php echo $this->get_field_id('show_counters'); ?>_2" name="<?php echo $this->get_field_name('show_counters'); ?>" value="1" <?php echo $show_counters==1 ? ' checked="checked"' : ''; ?> />
			<label for="<?php echo $this->get_field_id('show_counters'); ?>_1"><?php _e('Show', 'themerex'); ?></label>
