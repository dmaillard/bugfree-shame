...
<?php
	...
	function form( $instance ) {
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id( 'advert_image' ); ?>" name="<?php echo $this->get_field_name( 'advert_image' ); ?>" value="<?php echo esc_attr($advert_image); ?>" style="width:100%;" onchange="jQuery(this).siblings('img').get(0).src=this.value;" />
            <?php
			...
			if ($advert_image) {
			?>
	            <br /><br /><img src="<?php echo $advert_image; ?>" width="220" alt="" />
			<?php
			}
			?>
		</p>
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id( 'advert_link' ); ?>" name="<?php echo $this->get_field_name( 'advert_link' ); ?>" value="<?php echo esc_attr($advert_link); ?>" style="width:100%;" />
		</p>
