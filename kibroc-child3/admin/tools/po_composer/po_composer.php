		...
		<div class="po_composer">
			...
			<div class="po_composer_result">
				...
				<?php if (!empty($this->error_update)) { ?>
					<div class="error">
						<p><?php echo $this->error_update; ?></p>
					</div>
				<?php } ?>
					...
					<fieldset class="po_composer_block_inner">
						...
						<div class="po_composer_fields">
							<div class="po_composer_field">
								...
								<select name="po_src" id="po_src"><?php echo $options; ?></select>
							...
							<div class="po_composer_field po_composer_editor">
								...
								<div id="po_composer_editor_text" class="po_composer_editor_content">
									<textarea name="po_text" id="po_text"><?php echo $this->po_text; ?></textarea>
								</div>
					...
					<fieldset class="po_composer_block_inner">
						...
						<div class="po_composer_fields">
							<div class="po_composer_field">
								...
								<select name="po_src2" id="po_src2"><?php echo $options2; ?></select>
				...
				<div class="po_composer_buttons">
					...
					<div class="po_composer_links">
						<?php if (!empty($this->po_link)) { ?>
							<a href="<?php echo $this->po_link; ?>" class="po_composer_download_link"><?php _e('Download .PO-file', 'themerex'); ?></a>
						<?php } ?>
						<?php if (!empty($this->mo_link)) { ?>
							<a href="<?php echo $this->mo_link; ?>" class="po_composer_download_link"><?php _e('Download .MO-file', 'themerex'); ?></a>
						<?php } ?>
					</div>
					<?php } ?>
				</div>
