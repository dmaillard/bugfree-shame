...
<?php
	if (get_custom_option('show_login')=='yes') {
		if ( !is_user_logged_in() ) {
			?>
			<li class="usermenu_login"><a href="#user-popUp" class="user-popup-link"><?php _e('Login/Register', 'themerex'); ?></a></li>
			<?php 
		} else {
			$current_user = wp_get_current_user();
			?>
			<li class="usermenu_controlPanel">
				<a href="<?php echo site_url(); ?>/dashboard/"><span><?php echo $current_user->display_name; ?></span></a>
				<ul>
					<li><a href="<?php echo site_url(); ?>/dashboard/" class="icon icon-user"><?php _e('Dashboard', 'themerex'); ?></a></li>					
					<li><a href="<?php echo site_url(); ?>/create-listing/" class="icon icon-doc-inv"><?php _e('Create Listing', 'themerex'); ?></a></li>
					<li><a href="<?php echo site_url(); ?>/purchase-membership/" class="icon icon-paypal-1"><?php _e('Purchase Membership', 'themerex'); ?></a></li>
                    <li><a href="<?php echo site_url(); ?>/mes-evenements/" class="icon icon-paypal-1"><?php _e('Mes Événements', 'themerex'); ?></a></li>
