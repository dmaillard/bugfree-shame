								...
								<div class="co_options">
									<form name="co_form">
										...
										<div class="co_form_row">
											...
											<div id="co_bg_pattern_list">
												<?php for ($i=0; $i<=9; $i++) { ?>
												<a href="#" id="pattern_<?php echo $i; ?>" class="co_pattern_wrapper<?php echo $bg_pattern==$i ? ' current' : '' ; ?>"><img src="<?php echo themerex_get_file_url('/images/bg/pattern_'.$i.'_thumb2.png'); ?>" width="22" height="22" alt="" /></a>
												<?php } ?>
											</div>
										</div>
										<div class="co_form_row">
											...
											<div id="co_bg_images_list">
												<?php for ($i=1; $i<=6; $i++) { ?>
												<a href="#" id="image_<?php echo $i; ?>" class="co_image_wrapper<?php echo $bg_image==$i ? ' current' : '' ; ?>"><img src="<?php echo themerex_get_file_url('/images/bg/image_'.$i.'_thumb2.jpg'); ?>" width="48" height="28" alt="" /></a>
												<?php } ?>
											</div>
										</div>
									</form>
									<script type="text/javascript">
										jQuery(document).ready(function(){
											...
											jQuery('#co_menu_color').css('backgroundColor', '<?php echo $menu_color; ?>');
											jQuery('#co_user_menu_color').css('backgroundColor', '<?php echo $user_menu_color; ?>');
