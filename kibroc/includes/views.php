...
class CP_Renew_Listing extends APP_View_Page {
	...
	function __construct() {
		parent::__construct( 'renew-listing.php', __( 'Renew Listing', APP_TD ) );
	}
	...
	function template_include( $path ) {
		...
		$template = locate_template( 'renew-listing.php' );
...
class CP_Membership extends APP_View_Page {
	...
	function __construct() {
		parent::__construct( 'purchase-membership.php', __( 'Purchase Membership', APP_TD ) );
	}
	...
	function template_include( $path ) {
		...
		return locate_template( 'purchase-membership.php' );
	}
...
class CP_Edit_Item extends APP_View_Page {
	...
	function __construct() {
		parent::__construct( 'edit-listing.php', __( 'Edit Listing', APP_TD ) );
	}
